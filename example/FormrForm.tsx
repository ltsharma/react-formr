            ...
            return (
              <View
                ...
                <View
                  ...
                  <Text>
                    Rules (regex): has two uppercase letters. has one special
                    case letter. has two digits. has three lowercase letters.
                    string is of length 8.
                  </Text>
                  <TextInput
                    style={{
                      borderColor:
                ...
                <Button
                  onPress={() => onSubmitHandler(setSubmittedValue)}
                  title="Submit"
                  color="#ff5687"
